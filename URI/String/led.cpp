...
int main()
{
   ...
   /*Code*/
   	//Storing how many led needed to light a digit
   	int led[10]={
   	6,2, 5,5, 4,5, 6,3, 7,6
   	};
       ...
       for(char i='0';i<='9';i++){
       	//Counting number of digit occurrence 
   		m = count(s.begin(), s.end(),i);
   		//multiplying required leds with digit occurrence 
   		n+= m*led[j++];
   	}
   	cout<<n<<sp<<endl ;
   	}	
